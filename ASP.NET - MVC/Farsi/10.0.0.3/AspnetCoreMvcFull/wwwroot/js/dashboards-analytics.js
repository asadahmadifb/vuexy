...
(function () {
  ...
  //  For Datatable
  // --------------------------------------------------------------------
  var dt_projects_table1 = $('.datatables-projects1');

  if (dt_projects_table1.length) {
    var dt_project = dt_projects_table1.DataTable({
      ajax: assetsPath + 'json/user-profileProject.json',
      columns: [
        { data: '' },
        { data: 'id' },
        { data: 'project_name' },
