...
(function () {
  ...
  const horizontalBarChartEl = document.querySelector('#horizontalBarChart'),
    horizontalBarChartConfig = {
      ...
      labels: ['طرح سپاهان تک', 'همافرین', 'سیسکومارکت', 'اسنپ تریپ', 'مارکت جت', 'دیجی پی'],
      series: [
        {
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var $row_output =
              ...
              '</span>' +
              '<div>' +
              '<a class="text-body text-truncate fw-semibold mb-1 text-wrap" href="/Academy/CourseDetails">' +
              $course +
              '</a>' +
              '<div class="d-flex align-items-center">' +
